...
/**
 * Created by Muhunthanravi on 16/03/2017.
 */

public class yardbird extends AppCompatActivity {
    String json_url = "http://192.168.0.22/yardbird.php";
    ListView listView;
    ArrayList<User> users;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_yardbird);
        users = new ArrayList<>();
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET,json_url,(String)null,
                new Response.Listener<JSONArray>(){
                    ...
                    public void onResponse(JSONArray response) {
                        new yardbird.backgroundTask().execute(response);
                    }
    ...
    class backgroundTask extends AsyncTask<JSONArray,Void,ArrayList<User>> {
        ...
        protected void onPostExecute(ArrayList<User> users) {
            CustomAdapter customAdaptor = new CustomAdapter(yardbird.this, users);
