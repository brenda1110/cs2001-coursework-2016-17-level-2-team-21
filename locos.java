...
public class locos extends AppCompatActivity {
    String json_url = "http://192.168.0.22/locos.php";
    ListView listView;
    ArrayList<User> users;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_locos);
        users = new ArrayList<>();
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET,json_url,(String)null,
                new Response.Listener<JSONArray>(){
                    ...
                    public void onResponse(JSONArray response) {
                        new locos.backgroundTask().execute(response);
                    }
    ...
    class backgroundTask extends AsyncTask<JSONArray,Void,ArrayList<User>> {
        ...
        protected void onPostExecute(ArrayList<User> users) {
            CustomAdapter customAdaptor = new CustomAdapter(locos.this, users);
